...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { description: @medicine.description, title: @medicine.title } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { description: @medicine.description, title: @medicine.title } }
